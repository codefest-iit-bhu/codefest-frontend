...
export const LanguagequestEvent = ({ event }) => {
      ...
      <div className="min-h-screen flex flex-col pt-12">
        <div className="relative w-full flex-1 overflow-y-auto overflow-x-hidden">
          <div
            ...
            style={{
              backgroundImage: "url(/Languagequest.webp)",
                ...
                <div className="absolute inset-x-0 top-0 h-full mx-auto w-full max-w-[1600px] pointer-events-none">
                  <div className="relative w-full h-full pointer-events-none">
                    ...
                    >
                      {isMember ? (
                        <a
                          href="https://chat.whatsapp.com/KadLYA17sFLIL80DCuOuut"
                          target="_blank"
                      ...
                      <a
                        href="https://www.kaggle.com/competitions/language-challenge/overview"
                        target="_blank"
                        rel="noopener noreferrer"
...
export default LanguagequestEvent;
