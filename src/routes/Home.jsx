        ...
        <div className="relative flex flex-col items-center justify-start w-full px-4 pt-[12vh] pb-10 min-h-screen">
          ...
          <div className="relative w-full max-w-full md:h-[75vh] flex items-center justify-center my-4 md:my-0">
            ...
            <img
              src={heelsImg}
              alt="Heels"
              className="absolute left-[-2%] bottom-[0%] md:left-[5%] md:bottom-[0%] w-[35%] md:w-[22%] z-20 drop-shadow-xl"
            />
            ...
            <img
              src={maskImg}
              alt="Mask"
              className="absolute right-[-2%] top-[0%] md:right-[0%] md:top-[5%] w-[35%] md:w-[22%] rotate-12 z-20 drop-shadow-xl"
            />
