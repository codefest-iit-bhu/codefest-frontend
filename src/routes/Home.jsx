...
export default function Home() {
  return (
    <>
      ...
      {/* Fixed Background */}
      <div 
        className="w-full min-h-screen overflow-x-hidden text-[#e3dac9] font-body-serif bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: `url(${bgImg})` }}
      >
        
        {/* === HERO SECTION === */}
        <div className="relative flex flex-col items-center justify-start w-full px-4 pt-[12vh] pb-10 min-h-screen">
          ...
          <div className="relative w-full max-w-[90vw] flex justify-center items-center mb-[5vh] z-20">
            ...
            <h1 className="text-5xl sm:text-7xl md:text-9xl font-gatsby font-bold text-[#C5A059] drop-shadow-[0_4px_8px_rgba(0,0,0,0.8)] tracking-widest text-center">
              CODEFEST'26
            </h1>
          </div>
          ...
          <div className="relative w-full max-w-full md:h-[75vh] flex items-center justify-center my-4 md:my-0">
            ...
            <img 
              src={heelsImg} 
              alt="Heels" 
              className="absolute left-[-2%] bottom-[0%] w-[35%] md:w-[22%] z-20 drop-shadow-xl" 
            />
            ...
            <img 
              src={maskImg} 
              alt="Mask" 
              className="absolute right-[-2%] top-[0%] w-[35%] md:w-[22%] rotate-12 z-20 drop-shadow-xl"
            />

            {/* Letter Image (Background) */}
        ...
        <div className="flex flex-col w-full gap-24 pb-16 px-4 md:px-[5%]">
          ...
          <div className="w-full">
             <h2 className="text-4xl md:text-6xl text-[#FFD700] mb-12 border-b border-[#C5A059]/40 inline-block pb-2 tracking-wide font-gatsby pl-2 drop-shadow-md">
               LOOKBACK
             </h2>
          ...
          <div className="w-full mb-10">
             <h2 className="text-4xl md:text-6xl text-[#FFD700] mb-16 border-b border-[#C5A059]/40 inline-block pb-2 tracking-wide font-gatsby pl-2 drop-shadow-md">
               PREVIOUS SPONSORS
             </h2>
