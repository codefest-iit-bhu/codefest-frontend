      ...
      >
        ...
        >
          ...
          <div className="w-[90%] md:w-[80%] md:ml-[10%] text-center mb-1 border-b border-dotted border-[#3e2723] pb-1 shrink-0 z-10">
            <h3 className="text-[11px] md:text-xs font-bold uppercase mb-4 opacity-100">
              +50 for each CA referred, +20 for each user referred and +10 for
              participation of a referred member in an event.{" "}
            </h3>
            <h3 className="text-[9px] md:text-xs font-bold uppercase mb-0 opacity-80">
              Rewards
            </h3>
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-6 font-bold text-[9px] md:text-sm">
              ...
              <span className="text-[#5d4037]">To Be Announced</span> 
            </div>
          </div>
              ...
              <table className="w-full text-left border-collapse table-fixed text-xs md:text-sm">
                <thead className="sticky top-0 bg-[#e3dac9]/95 z-10 backdrop-blur-[2px]">
                  <tr className="border-b border-[#3e2723] font-bold uppercase">
                    <th className="w-[15%] md:w-[12%] py-1 text-center">
                      Rank
                    </th>
                    <th className="w-[45%] md:w-[38%] py-1 text-left pl-2">
                      Name
                    </th>
                    <th className="w-[25%] md:w-[35%] py-1 text-left hidden sm:table-cell">
                      Institute
                    </th>
                ...
                <tbody className="font-semibold">
                  {leaderboard.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan="4"
                        className="text-center py-8 opacity-60 italic"
                      >
