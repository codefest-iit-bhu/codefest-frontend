...
export default [
  {
    ...
    last_date_reg: "January 11, 2026 10:00:00",
    ...
    overview: `
        Vision Quest ’26 is a competitive computer vision event that challenges participants to solve real-world vision-based problems using modern machine learning and deep learning techniques.
    `,
    description: `<p>It's a 3-hour contest, having two sections usual CP questions and Quant-type puzzles.</p>
                  • It's a 3-hour contest, having two sections           
(usual CP questions and Quant-type puzzles).
• Participants have to register on the Hackerrank and codefest website. Participants have to use same email address on both platforms.
• Problems will be visible at the start of the contest. The link to the contest will be shared via email to registered participants.
• It's a 3-hour contest, having two sections           
(usual CP questions and Quant-type puzzles).
• Participants have to register on the Hackerrank and codefest website. Participants have to use same email address on both platforms.
• Problems will be visible at the start of the contest. The link to the contest will be shared via email to registered participants.
...
`,
  ...
  //         title: "HaXplore",
  //         date: "31 Jan, 2026, 12 AM IST - 2 Feb, 2026, 11:59PM IST",
  //         image_bg_path: "/Haxplore_bg.webp",
  //         last_date_reg: "January 30, 2026 23:59:00",
...

  {
    ...
    contact: [
      { name: "Shubham Jain", phone: "+91 98322 41448" },
    ]
  },
  // {
  //   id: "6",
