...
const EventCard = ({ title, date, lastDateReg, img_src }) => {
  ...
  return (
    <div
      className={`event-card hover:scale-105 overflow-hidden transition-all bg-cover bg-no-repeat bg-center duration-500 hover:bg-gray-900 z-[20] relative ${hasEnded ? "pointer-events-none opacity-60" : ""}`}
