...
import WinzoLeaderboard from "./routes/WinzoLeaderboard";
import WinzoReferrals from "./routes/WinzoReferrals";
import StockGame from "./routes/StockGame"; // ADD THIS
import StockGameAdmin from "./routes/Admin/StockGameAdmin"; // ADD THIS
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // ADD THESE TWO ROUTES (Stock Game Routes)
      {
        path: "/stock-game/:gameId",
        element: (
          <PrivateRoute>
